package ru.geekbrains.weather_app.view.details
...
import ru.geekbrains.weather_app.viewmodel.DetailsViewModel
...
class DetailsFragment : Fragment() {
    ...
    private fun getHeaderPicture(cityName: String) {
        when (cityName) {
            "Брянск" -> chosenHeaderPicture = "https://news.nashbryansk.ru/v2/uploads/" +
                    "news/images/2020/September/d7bac9bd9f33c728_XL(1).jpg"
